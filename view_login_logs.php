            ...
            <div class="login">
                ...
                <form method="POST">
                    <div class="password-wrapper">
                        <input type="password" id="admin-pwd-logs" name="admin_password" placeholder="Mot de passe admin">
                        <button type="button" class="toggle-password" onclick="togglePasswordVisibility('admin-pwd-logs')">👁️</button>
                    </div>
